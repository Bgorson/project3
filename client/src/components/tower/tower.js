...
class Tower extends Component {
    ...
    this.displayPet= (type,color,access) => {
        if (type=== 'cat'){
            if(color === 'white'){
                if(access === 'bell'){
                    ...
                    return <img alt="whitecatbanda" src={pet[3].image} />
                }
            ...
            if(color === 'white'){
                if(access === 'bell'){
                    ...
                    return <img alt="whitedogbandan" src={pet[0].image} />
                }
                ...
                if(access === 'bell'){
                    ...
                    return <img alt="orangedogbanda" src={pet[6].image} />
                }
            }
        }
        else {
        ...
        this.enemyPet= () => {
            return <img alt="pet" src={pet[this.state.opponentPet].image} />
        }
